    ...
    <section className="newsletter" aria-labelledby="newsletter-title">
      <div className="container newsletter__inner">
        <div className="newsletter__text">
          ...
          <p className="newsletter__sub">Assine a nossa newsletter e receba as novidades e conteúdos exclusivos da Econverse.</p>
        </div>
          ...
          <div className="newsletter__terms">
            <label className="newsletter__checkbox-label">
              ...
              <span className="newsletter__checkbox-text">
                Aceito os <a href="/termos" target="_blank" className="newsletter__link">termos e condições</a>
              </span>
            </label>
          </div>
        </form>
