  ...
  return (
    <header>
      ...
      <div className="header__announcement">
        <div className="container header__announcement-inner">
      ...
      <div className="header__main">
        <div className="container header__main-inner">
          ...
          <div className="header__actions">
            ...
            <div className="header__action-icon header__cart-icon" onClick={onCartClick}>
              <svg
                className="action__icon"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
      ...
      <nav className="header__nav">
        <div className="container header__nav-inner">
          <ul className="header__menu">
            <li><a href="/todas-categorias">TODAS CATEGORIAS</a></li>
            <li><a href="/supermercado">SUPERMERCADO</a></li>
            <li><a href="/livros">LIVROS</a></li>
            <li><a href="/moda">MODA</a></li>
            <li><a href="/lançamentos">LANÇAMENTOS</a></li>
            <li><a href="/ofertas-do-dia"><span><strong className="highlight">OFERTAS DO DIA</strong></span></a></li>
